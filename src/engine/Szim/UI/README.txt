...
- This UI is for Engine use, i.e. diagnostics, app/model editing, in-game
  ...
  It does NOT try to be a universal, one-size-fits-all front-end UI solution
  for every possible app (game)... (At least not yet.)

  But it does strive to be a usable out-of-the-box, initial/prototype UI
  for apps too, just to start out with something, easing early development.
