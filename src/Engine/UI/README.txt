...
- This UI is for Engine use, i.e. diagnostics, app/model editing, in-game
  ...
  It does NOT try to be a universal, one-size-fits-all UI solution for every
  possible app (game)!
...
*
Integrate this properly: make it "backended" like the rest.
...
think in terms of abstract UI integration points, so specific UI impls. can be
replaced as effortlessly as possible.
